					...
					<Progress.Section color="blue" value={percentage}>
						<Overlay color="#fff" backgroundOpacity={0} zIndex={10}>
							<Center>
								<Text
									style={{
										textShadow: `0 0 4px ${vanilla.colors.dark[4]}`,
										fontWeight: 500,
										fontSize: 13,
										color: "white",
										lineHeight: "24px",
...
const GoalNotFound = <Alert title="Oops!">Goal not found.</Alert>;

const EmptyState = <Alert title="Oops!">Goal not found.</Alert>;

const ErrorState = <Alert title="Oops!">Goal not found.</Alert>;
