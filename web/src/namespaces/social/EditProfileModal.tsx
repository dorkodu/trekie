import { useDorkoduStore } from '@/stores/apiStore'
import { useAppStore } from '@/shared/stores/appStore'
import { Button, Flex, Modal, TextInput, Textarea } from '@mantine/core'
import { useEffect, useState } from 'react'
import { useDorkoduStore } from '@/shared/stores/dorkoduStore'
...
function EditProfileModal() {
  ...
  const userId = useDorkoduStore($ => $.userId)
  const users = useApiStore($ => $.users)
