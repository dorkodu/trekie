            ...
            <Card className={cn("relative col-span-full flex overflow-hidden lg:col-span-2", glassBg)}>
              <CardContent className="relative size-fit">
                <div className="relative flex aspect-square size-14 bg-white rounded-xl dark:bg-black/40">
                  <Emoji className="m-auto" size={36} emoji="🗃️" />
                </div>
                <h2 className="my-4 text-2xl font-semibold">Your life, in one place.</h2>
                <p>Keep all your goals, habits, and tasks organized in one playful dashboard. See your progress clearly, celebrate wins, and feel in control of your personal journey.</p>
              </CardContent>
            </Card>
            <Card className={cn("relative col-span-full flex overflow-hidden lg:col-span-2", glassBg)}>
              <CardContent>
                ...
                <div className="relative z-10 mt-6 space-y-2">
                  ...
                  <p className="text-foreground">Define your biggest life goals and break them down into achievable steps. Trekie keeps you focused on what truly matters</p>
                </div>
              </CardContent>
            </Card>
            <Card className={cn("relative col-span-full flex overflow-hidden lg:col-span-2", glassBg)}>
