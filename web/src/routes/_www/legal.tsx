	...
	return (
		<Container size={760}>
			...
			<p>
				...
				<a href="https://dorkodu.com">https://dorkodu.com</a>. Please read these
				Terms carefully before accessing or using the website. Your access to
			...
			<p>
				...
				and will remain the exclusive property of Dorkodu and its licensors. The
				service is protected by copyright, trademark, and other laws of both the
				Turkey and foreign countries. Our trademarks and trade dress may not be
			...
			<p>
				...
				are not owned or controlled by Dorkodu.
			</p>
			<p>
				Dorkodu has no control over, and assumes no responsibility for, the
				content, privacy policies, or practices of any third-party websites or
				services. You further acknowledge and agree that Dorkodu shall not be
			...
			<p>
				...
				of the Republic of Turkey, without regard to its conflict of law
				provisions.
			</p>
			<p>
			...
			<ul>
				...
				<li>
					<p>
						...
						this Agreement) refers to Dorkodu.
					</p>
				</li>
				<li>
					<p>
...
const CommunityRules = () => {
	return (
		<Container size={760}>
			...
			<p>
				<b>
					We believe that everyone should have access to free tools for
					gamification, productivity and social media
				</b>
				. Our guidelines are meant to build a mutual understanding of what being
				a part of this community is all about. We will take action if any of
				these guidelines are not upheld, so please read carefully.
			</p>

			<h2>Always be Respectful</h2>
			<p>
				We come together from across the world at varying experiences with the
				same goal in mind - to grow. Curiosity, questioning, and cultural
			...
			<p>
				We are all in this together. Life-wide gamification and productivity is
				hard and takes a lot of courage and dedication. If someone makes "easy"
				mistakes or has a question you think has an obvious answer, kindly and
				calmly help them out. Heckling and being straight up mean doesn’t help
				anyone learn. Can’t say it nicely? Don’t weigh in.
			</p>

			<h2>Embrace and share differences</h2>
			<p>
				A language can have many words, accents and ways to say the same thing.
				We think that’s one of the wonders of languages. Approach these
				conversations with an open mind and attitude.
			</p>

			<h2>Think before you share</h2>
			<p>
				We care about your safety. Online communities are inherently social, but
				please beware of swapping or posting any private information that could
				be misused. That includes your phone number, age, address, what time
				you’ll be at home, school name, email, or other personal information
				that could put your privacy at risk. Simply put: don’t over-share.
				Sharing and encouraging others to share personal data might get your
				post, and possibly your account, removed.
			</p>

			<h2>Do Not...</h2>
			<p>
				<b>
					Please don’t use any of Dorkodu's Websites, Apps and any other
					Product/Services with bad and ingeniuine intentions.
				</b>
			</p>

			<h3>Don't attack anyone with words or actions.</h3>
			<p>
				Dorkodu is a safe place for members of all backgrounds. Harassment and
				hurtful content will not be tolerated. Using symbols, names and text
				that promote hate—as well as harassing, stalking, impersonating, and
				making sexual remarks towards someone—are considered abuse. The same
				goes for nudity and disturbing profile pictures and usernames. As stated
				in the terms, Dorkodu reserves the right to replace images or remove
				these accounts at its sole discretion.
			</p>
			<p>
				Rule of thumb: if you are making someone feel attacked or hurt, then you
				shouldn’t be doing it. We take these reports seriously and may delete
				your account without previous notice if such activity is verified by our
				team.
			</p>

			<h3>Don't script or cheat maliciously.</h3>
			<p>
				Dorkodu believes in honest effort. If you are scripting for the purposes
				of cheating or sharing information and instructions about using Dorkodu
				in a way that may impact the system, community, sharing, learning, data
				or experience in a negative or significant manner, your account and
			...
			<p>
				<b>Please don't waste your time looking for loopholes.</b> We will
				remove any content that violates the spirit of these guidelines and you
				will risk losing partial or full access to Dorkodu without warning. By
				following these guidelines, we will all contribute to an interesting and
		...
		<Container size={760}>
			<Group wrap="nowrap" maw={440}>
				...
				<Stack gap={0}>
					...
					{/* <Text span inherit variant="gradient" gradient={{ from: "#17CC38", to: "#6BD731", deg: 60 }}> Gamification</Text> */}
					<Title order={2} c="dimmed" fw={600} lh={1.2} size={18} mt={4}>
						What we do with small pieces of information we store to enhance the
						experience.
					</Title>
				</Stack>
			</Group>
			...
			<ul>
				<li>
					<strong>Company</strong> (referred to as either &quot;the
					Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
					this Cookies Policy) refers to Dorkodu, Istanbul, Turkey.
				</li>
				<li>
			...
			<p>
				For any other web browser, please visithey@dorkodu.com your web
	...
	return (
		<Container size={760}>
			...
			<p>
				...
				invite You to review our policy on refunds.
			</p>
			<p>
			...
			<ul>
				<li>
					<p>
						<strong>Application</strong> means one of the software programs
						provided by the Company downloaded by You on any electronic device,
						which are named Dorkodu, Trekie or Minicards.
					</p>
				</li>
				<li>
					<p>
						<strong>Company</strong> (referred to as either &quot;the
						Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
						this Agreement) refers to Dorkodu, legally represented by Doruk Eray
						and Berk Cambaz.
					</p>
				</li>
				<li>
				...
				<li>
					<p>
						<strong>Website</strong> refers to Dorkodu's official website,
						accessible from{" "}
						<a href="https://dorkodu.com" target="_blank">
							https://dorkodu.com
						</a>
					</p>
				</li>
			...
			<ul>
				...
				<li>
					By submitting the form on our website: https://dorkodu.com/refund
				</li>
			</ul>
			<p>
			...
			<p>
				...
				discount cannot be refunded. This exclusion may not apply to You if it
