...
const CookiePolicy = () => {
  return (
    <Container size={760}>
      ...
      <p>For any other web browser, please visithey@dorkodu.com your web browser's official web pages.</p>
...
const RefundPolicy = () => {
  return (
    <Container size={760}>
      ...
      <ul>
        <li>
          <p><strong>Application</strong> means one of the software programs provided by the Company downloaded by You on any electronic device, which are named Dorkodu, Trekie or Minicards.</p>
        </li>
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Dorkodu, legally represented by Doruk Eray and Berk Cambaz.</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Website</strong> refers to Dorkodu's official website, accessible from <a href="https://dorkodu.com" target="_blank">https://dorkodu.com</a></p>
        </li>
        <li>
          <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
        </li>
      ...
      <ul>
        <li>By email: <Anchor href="mailto:hey@dorkodu.com">hey@dorkodu.com</Anchor></li>
      ...
      <p>Only regular priced Goods may be refunded. Unfortunately, Goods on discount cannot be refunded. This exclusion may not apply to You if it is not permitted by applicable law.</p>
      <h2>Returning Goods</h2>
      <p>You are responsible for the cost and risk of returning the Goods to Us. You should send the Goods at the following address:</p>
      <b><p>Bebek, BÜ Güney Kampüsü, 34342 Beşiktaş/İstanbul</p></b>
      ...
      <h3>Contact Us</h3>
      <p>If you have any questions about our Returns and Refunds Policy, please contact us: <Anchor href="mailto:hey@dorkodu.com">hey@dorkodu.com</Anchor></p>
    </Container>
  )
}
