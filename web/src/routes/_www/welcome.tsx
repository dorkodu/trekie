...
import GlassCard from "@web/components/cards/GlassCard";
		...
		<Paper p={10}>
			<SimpleGrid cols={{ base: 1, sm: 2 }}>
				<Stack gap="sm">
					...
					<Text size="lg" lh={1} fw={800} c="dimmed" ta="center">
						INTRODUCING TREKIE
					</Text>
					<Title
						style={{
				...
				<BackgroundImage
					src={useThemed({
						light:
							"https://images.unsplash.com/photo-1597200381847-30ec200eeb9a?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
...
import { useThemed } from "new/src/hooks";
